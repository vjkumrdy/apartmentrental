...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyviewHolder> {
    ...
    public HomeAdapter(Context context, List<HomePojo> categoty) {
        this.context = context;
        this.a1 = categoty;
    }

    public void setMovieList(List<HomePojo> a1) {
        this.a1 = a1;
    ...
    public void onBindViewHolder(@NonNull MyviewHolder holder, final int pos) {
        ...
        holder.tv_time_spam.setText(" -"+a1.get(pos).getTime_spam());
        holder.tv_beds.setText(a1.get(pos).getBed());
        holder.tv_pets.setText(a1.get(pos).getPets());
        holder.tv_sq_feet.setText(a1.get(pos).getSq_ft());
        holder.tv_apart_type.setText(a1.get(pos).getApart_type());
        holder.tv_offer.setText(a1.get(pos).getAddress());
