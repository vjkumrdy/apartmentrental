...
import com.findinganapartment.adapters.MyRequestAdapter;
...
public class MyRequestActivity extends AppCompatActivity {
    ...
    public void serverData(){
        progressDialog = new ProgressDialog(MyRequestActivity.this);
        progressDialog.setMessage("Loading....");
        progressDialog.show();

        ApiService service = RetroClient.getRetrofitInstance().create(ApiService.class);
        Call<List<MyRequestPojo>> call = service.myrequests(session);
        call.enqueue(new Callback<List<MyRequestPojo>>() {
            ...
            public void onResponse(Call<List<MyRequestPojo>> call, Response<List<MyRequestPojo>> response) {
                ...
                if(response.body()==null){
                    Toast.makeText(MyRequestActivity.this,"No data found", Toast.LENGTH_SHORT).show();
                }else {
                    a1 = response.body();
                    myRequestAdapter=new MyRequestAdapter(a1, MyRequestActivity.this);  //attach adapter class with therecyclerview
            ...
            public void onFailure(Call<List<MyRequestPojo>> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(MyRequestActivity.this, "Something went wrong...Please try later!", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
