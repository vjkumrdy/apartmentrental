...
public class BookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Request Property");
        ...
        property_id.setText("Property Id  :"+getIntent().getStringExtra("pid"));
    ...
    public  void serverData() {
        ...
        Call<ResponseData> call = apiService.booknow(getIntent().getStringExtra("pid"),getIntent().getStringExtra("uname"),et_msg.getText().toString());
        call.enqueue(new Callback<ResponseData>() {
            @Override
            public void onResponse(Call<ResponseData> call, Response<ResponseData> response) {
                if (response.body().message.equals("true")) {
                    Toast.makeText(BookingActivity.this, response.body().message, Toast.LENGTH_LONG).show();
