...
public class RegistrationActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    Button register_btn,btn_upload;
    ...
    private void uploadImageToServer(){
        ...
        map.put("phonenumber",et_phno.getText().toString());
        map.put("role",spin_select.getSelectedItem().toString());
        map.put("pwd",et_pwd.getText().toString());
