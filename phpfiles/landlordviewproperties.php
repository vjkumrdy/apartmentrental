...
$teams_query = "SELECT * FROM add_property where a_status='Verified' and p_owner!='$email' ";
...
,'p_owner' => $row['p_owner'],'a_status' => $row['a_status'],'location' => $row['location'],'description' => $row['description'],'type' => $row['type'],'per' => $row['per']);
}
